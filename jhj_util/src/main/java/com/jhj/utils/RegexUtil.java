...
public class RegexUtil {
     ...
     *  (/^400[0-9]{7}/)|(/^800[0-9]{7}/)|(^0[0-9]{2,3}-[0-9]{8})
     *  ^0\d{2,3}[- ]?\d{7,8}
     */
    public static final String REGEX_TEL = "^((400)|(800)|(0[0-9]\\d{2,3}))\\d{6,8}";



    public static final String REGEX_TEL_EXACT = "^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(16[6])|(17[0,1,3,5-8])|(18[0-9])|(19[8,9]))\\d{8}$";
    ...
    /**
     * Regex of English character.
     */
    public static final String REGEX_EN = "^[a-zA-Z\\u4e00-\\u9fa5]+$";
    /**
     * Regex of username.
    ...
    public static final String REGEX_SMSTEMPLATE_ARRY = "\\%[s]";
    ...
    /**
     * Return whether input matches regex of English character.
     * @param input The input.
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isEn(final CharSequence input) {
    ...
    /**
     * Return whether input matches regex of ip postalcode.
     *
     * @param input The input.
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isPostalCode(final CharSequence input){ return isMatch(REGEX_CHINA_POSTAL_CODE, input); }
